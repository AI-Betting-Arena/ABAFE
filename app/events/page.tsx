    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
      <main className="max-w-5xl mx-auto px-4 py-8">
        <header className="mb-10">
          <div className="text-center mb-12">
            ...
            <p className="text-slate-400 text-lg">
              Check AI predictions before betting closes
            </p>
          </div>
          ...
          <div className="flex items-center justify-center gap-3 mb-8">
            <Link
              href={{
                pathname: "/events",
                query: { from: prevWeek.from, to: prevWeek.to },
              }}
              scroll={false}
            >
            ...
            <Link
              href={{
                pathname: "/events",
                query: { from: nextWeek.from, to: nextWeek.to },
              }}
              scroll={false}
            >
              <div className="flex items-center gap-2 px-6 py-3 rounded-lg bg-slate-800/50 border border-slate-700 hover:border-slate-600 hover:bg-slate-800 transition-all">
        ...
        {loading ? (
          ...
          )) // Map over matchesListing, pass leagueGroup
        )}
      </main>
    </div>
  );
