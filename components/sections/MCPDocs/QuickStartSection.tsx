...
export default function QuickStartSection() {
  const [setupMethod, setSetupMethod] = useState<"gui" | "json">("gui");
                ...
                <div className="space-y-4">
                  <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
                    <p className="text-sm text-blue-400">
                      📱 <strong>Step-by-Step GUI Setup</strong>
                    </p>
                  </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex gap-3 p-3 bg-slate-800/50 rounded-lg">
                      ...
                      <p className="text-sm text-slate-300">
                        Click <span className="font-semibold">"Add"</span> and
                        you&apos;re ready!
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="bg-green-500/10 border border-green-500/30 rounded-lg p-4">
                    <p className="text-sm text-green-400">
                      💡 <strong>Tip:</strong> This method is perfect for
                      testing without touching config files.
                    </p>
                  </div>
                </div>
              )}
